export const rerollPassivesFW = [
    ...
    {
        title: "Potenza di Tiro + (Fuoco) [シュートパワー＋〈火〉]",
        id: "REROLL_FW_SHOOT_POWER_FIRE",
        template: "Aumenta la potenza delle tecniche di Tiro di elemento Fuoco di {VAL}.",
        levels: [
            { val: 3, req: "Livello 1" },
            { val: 5, req: "Livello 2" },
            { val: 8, req: "Livello 3" },
    ...
    {
        title: "Potenza di Tiro + (Montagna) [シュートパワー＋〈山〉]",
        id: "REROLL_FW_SHOOT_POWER_MOUNTAIN",
        template: "Aumenta la potenza delle tecniche di Tiro di elemento Montagna di {VAL}.",
        levels: [
            { val: 3, req: "Livello 1" },
            { val: 5, req: "Livello 2" },
            { val: 8, req: "Livello 3" },
        ...
        conditions: null,
        effects: [
            { targetScope: "self", targetRoles: [], targetElements: ["Mountain"], type: "power", moveKind: "Tiro", moveElement: "Mountain", valueRef: "val" }
        ]
    },
    {
        title: "Potenza di Tiro + (Vento) [シュートパワー＋〈風〉]",
        id: "REROLL_FW_SHOOT_POWER_WIND",
        template: "Aumenta la potenza delle tecniche di Tiro di elemento Vento di {VAL}.",
        levels: [
            { val: 3, req: "Livello 1" },
            { val: 5, req: "Livello 2" },
            { val: 8, req: "Livello 3" },
    ...
    {
        title: "Potenza di Tiro + (Bosco) [シュートパワー＋〈林〉]",
        id: "REROLL_FW_SHOOT_POWER_FOREST",
        template: "Aumenta la potenza delle tecniche di Tiro di elemento Bosco di {VAL}.",
        levels: [
            { val: 3, req: "Livello 1" },
            { val: 5, req: "Livello 2" },
            { val: 8, req: "Livello 3" },
